...
const getSubtaskById = async (collectionName, docName) => {
    ...
    {
        // perform fetch https://paymemobile.fr/subtasks
        console.log('Querying ' + docName + ' with token ' + token)
        const response = await fetch('https://paymemobile.fr/subtask?token='+token+'&practicalId=' + docName)
        const data = await response.json()
...
const saveSubtask = async (practicalId, data) => {
    ...
    const response = await fetch('https://paymemobile.fr/saveSubtask?token='+token, {
        method: 'POST',
        headers: {
...
const deleteSubtask = async (practicalId) => {
    // perform post https://paymemobile.fr/subtasks
    const response = await fetch('https://paymemobile.fr/deleteSubtask?token='+token+'&practicalId=' + practicalId)
    const responseData = await response.json()
    console.log(responseData)
}
